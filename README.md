About hachoir-subfile-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hachoir-subfile-feedstock/blob/main/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `hachoir-subfile` can be installed with `conda`:
...
```
mamba install hachoir-subfile
```

It is possible to list all of the versions of `hachoir-subfile` available on your platform with `conda`:
...
```
mamba search hachoir-subfile --channel conda-forge
```
...
mamba repoquery search hachoir-subfile --channel conda-forge

# List packages depending on `hachoir-subfile`:
mamba repoquery whoneeds hachoir-subfile --channel conda-forge

# List dependencies of `hachoir-subfile`:
mamba repoquery depends hachoir-subfile --channel conda-forge
```
